...
do
	...
	/home/rsicko/bin/bcftools/bcftools filter -i 'FMT/DP>=13 & FMT/AF[*]>=0.29 & FMT/AO[*]>=8 & FMT/FAO[*]>=8 & FMT/FDP[*]>=13 & INFO/QD>=2.34 & QUAL>=52.6 & INFO/FWDB[*]>=-0.129 & INFO/SSSB[*]>=-0.613 & INFO/VARB[*]>=-0.285' -m x -s + $vcf > $newFileName
